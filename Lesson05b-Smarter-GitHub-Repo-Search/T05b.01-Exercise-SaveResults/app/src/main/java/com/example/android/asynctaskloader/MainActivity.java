...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_JSON_RESULT_KEY = "search_json_key";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            String urlDisplay = savedInstanceState.getString(QUERY_URL_KEY);
            mUrlDisplayTextView.setText(urlDisplay);
            String searchJsonResult = savedInstanceState.getString(SEARCH_JSON_RESULT_KEY);
            mUrlDisplayTextView.setText(searchJsonResult);
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        if (queryUrl != null) {
            outState.putString(SEARCH_JSON_RESULT_KEY, searchResult);
        }
    }
