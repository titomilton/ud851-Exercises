...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)) {
            String lifecycleCallbackText = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
            if(lifecycleCallbackText != null) {
                mLifecycleDisplay.setText(lifecycleCallbackText);
            }
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String txt = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, txt);
